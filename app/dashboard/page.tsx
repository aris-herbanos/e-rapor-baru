    ...
    <main className="min-h-screen bg-[#f5f7f5]">
      ...
      <section className="mx-auto max-w-6xl px-5 py-7 sm:px-8 lg:py-9">
        <div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="mt-1.5 max-w-xl text-sm leading-6 text-slate-500">
              Kelola data akademik, kurikulum, asesmen, dan rapor santri dalam satu sistem yang terintegrasi.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-xs leading-5 text-slate-500">
                  Gunakan menu di bawah untuk mengelola data guru, mata pelajaran, kurikulum, hingga penilaian santri.
                </p>
              </div>
            </div>
        ...
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-slate-500">Pilih modul yang ingin Anda kelola.</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-5 flex items-start justify-between">
                  <div className={`flex h-11 w-11 items-center justify-center rounded-xl ring-1 ${colorMap[menu.color]}`}>
                    <Icon size={21} strokeWidth={1.8} />
                  </div>
                  <ArrowRight size={17} className="text-slate-300 transition group-hover:translate-x-0.5 group-hover:text-emerald-600" />
                </div>

                <h4 className="text-sm font-bold text-slate-800">{menu.title}</h4>
                <p className="mt-1.5 min-h-[40px] text-xs leading-5 text-slate-500">{menu.description}</p>
        ...
        <div className="mt-8 flex flex-col gap-3 border-t border-slate-200 pt-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-semibold text-slate-600">Pondok Pesantren Terpadu Ulil Albab</p>
            <p className="mt-0.5 text-[11px] text-slate-400">Sistem E-Rapor & Manajemen Akademik</p>
          </div>
          <div dir="rtl" className="font-serif text-sm text-slate-400">
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center pt-8">
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-red-50">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-red-100">
                  <LockKeyhole size={27} strokeWidth={2} className="text-red-600" />
                </div>
              </div>
            </div>
            ...
            <div className="px-7 pb-8 pt-5 text-center">
              ...
              <h2 id="forbidden-title" className="text-xl font-bold tracking-tight text-slate-800">
                Akses Ditolak
              </h2>
              ...
              <div className="mt-5 rounded-2xl border border-red-100 bg-red-50/70 p-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-red-700">Khusus Administrator</p>
